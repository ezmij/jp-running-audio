...
SHEETS = [
    ...
    {"title": "口腔訓練", "slug": "koku", "schema": "mrjp",
     "display_name": "每天五分鐘，訓練你的口去適應日語"},
    {"title": "口腔訓練", "slug": "koku-transcript", "schema": "mrjp-transcript",
     "display_name": "每天五分鐘，訓練你的口去適應日語 — 全文對照"},
    {"title": "不安な脳", "slug": "fuan-nou", "schema": "mrjp"},
    {"title": "不安な脳", "slug": "fuan-nou-transcript", "schema": "mrjp-transcript",
     "display_name": "不安な脳 — 全文對照"},
    {"title": "日語思考訓練", "slug": "think-jp", "schema": "mrjp"},
    {"title": "日語思考訓練", "slug": "think-jp-transcript", "schema": "mrjp-transcript",
     "display_name": "日語思考訓練 — 全文對照"},
